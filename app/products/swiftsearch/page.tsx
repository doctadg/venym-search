...
export default function SwiftSearchPage() {
                ...
                <div className="flex-1 space-y-8">
                  <div className="space-y-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-none">
                      <span className="block text-[#efa72d]">SWIFTSEARCH</span>
            ...
            <div className="container px-4 md:px-6 mx-auto max-w-7xl">
              <div className="text-center mb-16">
                <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-6">
                  WHY DEVELOPERS CHOOSE SWIFTSEARCH
                </h2>
            ...
            <div className="container px-4 md:px-6 mx-auto max-w-7xl">
              <div className="text-center mb-16">
                ...
                <p className="text-xl font-bold max-w-3xl mx-auto">
                  Real companies using SwiftSearch to power their products
                </p>
              </div>
            ...
            <div className="container px-4 md:px-6 mx-auto max-w-7xl text-center">
              <div className="max-w-4xl mx-auto space-y-8">
                ...
                <p className="text-xl font-bold">
                  Join 3,200+ developers who chose SwiftSearch over building their own scraping infrastructure.
                </p>
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  ...
                  <Link href="https://docs.VENYM_SEARCH.com/swiftsearch">
                    <Button
                      variant="outline"
                      size="lg"
            ...
            <div className="grid gap-8 lg:grid-cols-4">
              ...
              <div className="space-y-4">
                ...
                <nav className="flex flex-col gap-2">
                  <Link href="/products/swiftsearch" className="font-black text-[#efa72d] hover:text-white transition-colors">
                    SwiftSearch
                  </Link>
