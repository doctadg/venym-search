...
export const metadata: Metadata = {
  title: 'SwiftSearch API - Real-time Search + Auto-Scraping | Venym Search',
  ...
  openGraph: {
    title: 'SwiftSearch API - Search + Scrape in One Call',
    ...
    url: 'https://search.venym.io/products/swiftsearch',
    siteName: 'Venym Search',
    images: [
      {
        url: 'https://search.venym.io/og-swiftsearch.png',
        width: 1200,
        height: 630,
        alt: 'SwiftSearch API Product'
      }
    ],
    type: 'website'
  },
  twitter: {
    ...
    title: 'SwiftSearch API - Search + Scrape in One Call',
    description: 'Get search results AND full page content automatically. Extract contacts and social profiles from every result.',
    images: ['https://search.venym.io/og-swiftsearch.png']
  },
  alternates: {
    canonical: 'https://search.venym.io/products/swiftsearch'
  }
}
