                ...
                <div className="flex-1 space-y-8">
                  <div className="space-y-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-none">
                      <span className="block text-[#efa72d]">DEEPDIVE</span>
                    ...
                    <p className="text-xl md:text-2xl font-bold leading-relaxed max-w-2xl">
                      Research any topic across multiple sources with AI analysis. Get comprehensive reports, 
                      competitive intelligence, and actionable insights—all automated.
                    </p>
                  </div>
                  ...
                  <Card className="bg-black border-4 border-[#efa72d] shadow-[12px_12px_0px_0px_#efa72d]">
                    <CardContent className="p-8">
                      <pre className="text-green-400 font-mono text-sm overflow-x-auto">
                        {`curl -X POST "https://search.venym.io/api/v1/deepdive" \
  -H "X-API-Key: sk_live_YOUR_API_KEY_key" \\
  -H "Content-Type: application/json" \\
  -d '{
    "topic": "AI productivity tools market 2025",
    "max_sources": 20,
...
# ✓ Executive summary`}
            ...
            <div className="container px-4 md:px-6 mx-auto max-w-7xl">
              <div className="text-center mb-16">
                <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-6">
                  WHY ENTERPRISES CHOOSE DEEPDIVE
                </h2>
                ...
                {[
                  {
                    ...
                    description: "Advanced AI models analyze and synthesize information from multiple sources to deliver actionable insights.",
                    metric: "95% accuracy"
                  },
                  {
                    icon: Clock,
                    title: "50X FASTER RESEARCH",
                    description: "Complete comprehensive research in minutes instead of weeks. Automate data collection, analysis, and reporting.",
                    metric: "Hours → Minutes"
                  },
                  {
                    icon: PieChart,
                    title: "COMPETITIVE INTELLIGENCE",
                    description: "Track competitors, analyze market trends, and identify opportunities with automated competitive analysis.",
                    metric: "360° insights"
                  }
                ].map((benefit, index) => (
          ...
          <section className="w-full py-10 sm:py-20 bg-[#17457c]">
            <div className="container px-4 md:px-6 mx-auto max-w-7xl">
              ...
              <Tabs defaultValue="multi-source" className="w-full max-w-6xl mx-auto">
                <TabsList className="flex w-full overflow-x-auto bg-[#6b839a] border-2 sm:border-4 border-[#efa72d]">
                  <TabsTrigger value="multi-source" className="font-black whitespace-nowrap data-[state=active]:bg-[#efa72d] data-[state=active]:text-[#17457c] text-[#edf3f1] text-xs sm:text-sm flex-shrink-0">
                    Multi-Source
                  </TabsTrigger>
                  <TabsTrigger value="ai-analysis" className="font-black whitespace-nowrap data-[state=active]:bg-[#efa72d] data-[state=active]:text-[#17457c] text-[#edf3f1] text-xs sm:text-sm flex-shrink-0">
                    AI Analysis
                  </TabsTrigger>
                  <TabsTrigger value="competitive" className="font-black whitespace-nowrap data-[state=active]:bg-[#efa72d] data-[state=active]:text-[#17457c] text-[#edf3f1] text-xs sm:text-sm flex-shrink-0">
                    Competitive Intel
                  </TabsTrigger>
                  <TabsTrigger value="insights" className="font-black whitespace-nowrap data-[state=active]:bg-[#efa72d] data-[state=active]:text-[#17457c] text-[#edf3f1] text-xs sm:text-sm flex-shrink-0">
                    Smart Insights
                  </TabsTrigger>
                </TabsList>

                <TabsContent value="multi-source" className="mt-8">
                  <div className="grid gap-8 lg:grid-cols-2 items-center">
                    <div className="space-y-6">
                      <h3 className="text-3xl font-black text-[#efa72d]">Research Across All Sources</h3>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <CheckCircle className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Web Sources</p>
                            <p className="text-gray-300">News sites, blogs, company websites, and industry publications</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <CheckCircle className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Social Intelligence</p>
                            <p className="text-gray-300">Social media mentions, sentiment analysis, and trending topics</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <CheckCircle className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Academic Sources</p>
                            <p className="text-gray-300">Research papers, patents, and academic publications</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
{`{
  ...
  "last_updated": "2024-01-20T15:30:00Z"
                ...
                <TabsContent value="ai-analysis" className="mt-8">
                  <div className="grid gap-8 lg:grid-cols-2 items-center">
                    <div className="space-y-6">
                      <h3 className="text-3xl font-black text-[#efa72d]">Advanced AI Content Analysis</h3>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <Sparkles className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Sentiment Analysis</p>
                            <p className="text-gray-300">Understand market sentiment and public opinion</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <FileText className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Key Insights Extraction</p>
                            <p className="text-gray-300">Automatically identify important trends and patterns</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <Network className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Entity Recognition</p>
                            <p className="text-gray-300">Identify companies, people, products, and relationships</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
{`{
  ...
  "entities": [
    {"name": "OpenAI", "type": "company", "mentions": 23},
    {"name": "GPT-4", "type": "product", "mentions": 18}
  ]
}`}
                        </pre>
                      </CardContent>
                ...
                <TabsContent value="competitive" className="mt-8">
                  <div className="grid gap-8 lg:grid-cols-2 items-center">
                    <div className="space-y-6">
                      <h3 className="text-3xl font-black text-[#efa72d]">Competitive Intelligence Engine</h3>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <Building2 className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Competitor Tracking</p>
                            <p className="text-gray-300">Monitor competitor moves, announcements, and strategies</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <BarChart3 className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Market Positioning</p>
                            <p className="text-gray-300">Analyze competitive landscape and market gaps</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <TrendingUp className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Opportunity Identification</p>
                            <p className="text-gray-300">Discover untapped markets and growth opportunities</p>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  "competitors": [
    {
      ...
      "market_share": 0.32,
      "growth_rate": 0.15,
      "strengths": ["pricing", "features"],
      "weaknesses": ["support", "ui"]
    }
  ],
  "market_gaps": [
  ...
  "opportunities": [
    ...
    "International expansion"
                ...
                <TabsContent value="insights" className="mt-8">
                  <div className="grid gap-8 lg:grid-cols-2 items-center">
                    <div className="space-y-6">
                      <h3 className="text-3xl font-black text-[#efa72d]">Actionable Intelligence Reports</h3>
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          <Brain className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Executive Summaries</p>
                            <p className="text-gray-300">AI-generated executive briefings with key takeaways</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <Lightbulb className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Strategic Recommendations</p>
                            <p className="text-gray-300">Data-driven recommendations for business decisions</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <Shield className="h-6 w-6 text-[#efa72d] mt-1 flex-shrink-0" />
                          <div>
                            <p className="font-black text-lg">Risk Assessment</p>
                            <p className="text-gray-300">Identify potential risks and mitigation strategies</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <Card className="bg-black border-4 border-[#efa72d]">
                      <CardContent className="p-6">
                        <pre className="text-green-400 font-mono text-sm">
{`{
  "executive_summary": "The AI productivity tools market shows strong growth...",
  "recommendations": [
    {
      "priority": "high",
      "action": "Focus on enterprise features",
      "impact": "Market share increase",
      "timeframe": "Q2 2024"
    }
  ],
  "risks": [
            ...
            <div className="container px-4 md:px-6 mx-auto max-w-7xl">
              <div className="text-center mb-16">
                ...
                <p className="text-xl font-bold max-w-3xl mx-auto">
                  Leading companies trust DeepDive for critical research decisions
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: "Comprehensive market analysis, competitor tracking, and trend identification for strategic planning and investment decisions.",
                    example: "Research 'SaaS market trends 2025' → Get industry report with growth projections",
                    companies: "Used by 1,100+ analysts"
                  },
                  {
                    icon: Building2,
                    title: "Due Diligence", 
                    description: "Deep research on companies, executives, and market opportunities for M&A, investment, and partnership decisions.",
                    example: "Analyze target company → Get comprehensive risk assessment and opportunities",
                    companies: "Used by 450+ investment firms"
                  },
                  {
                    icon: Users,
                    title: "Competitive Intelligence",
                    description: "Monitor competitors, track product launches, and identify strategic moves to stay ahead in your market.",
                    example: "Track competitor activity → Get real-time alerts and strategic insights",
                    companies: "Used by 890+ product teams"
                  },
                  {
                    icon: GraduationCap,
                    title: "Academic Research",
                    description: "Accelerate research projects with automated literature reviews, citation analysis, and trend identification.",
                    example: "Research 'quantum computing breakthroughs' → Get academic summary with citations",
                    companies: "Used by 320+ researchers"
                  }
                ].map((useCase, index) => (
                  <Card key={index} className="bg-black text-white border-4 border-black shadow-[8px_8px_0px_0px_#000000]">
                    <CardContent className="p-8">
          ...
          <section className="w-full py-10 sm:py-20 bg-[#17457c]">
            <div className="container px-4 md:px-6 mx-auto max-w-7xl">
              <div className="text-center mb-16">
                ...
                <div className="w-48 h-3 bg-[#efa72d] mx-auto mb-6"></div>
                <p className="text-xl font-bold max-w-3xl mx-auto">
                  Advanced AI features require Builder+ plans for optimal performance
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    price: "$0",
                    credits: "500 credits",
                    description: "Basic research capabilities",
                    features: ["Simple research queries", "Basic summaries", "Limited sources (5 max)"],
                    popular: false,
                    available: true
                  },
                  {
                    ...
                    features: ["+ Advanced summaries", "+ Email support", "+ Higher rate limits"],
                    popular: false,
                    available: true
                  },
                  {
                    ...
                    description: "Full AI research automation",
                    features: ["+ AI analysis & insights", "+ Competitive intelligence", "+ Unlimited sources"],
                    popular: true,
                    available: true
                  },
                  {
                    ...
                    description: "Enterprise research at scale",
                    features: ["+ Custom AI models", "+ White-label reports", "+ Dedicated support"],
                    popular: false,
                    available: true
                  }
                ].map((plan, index) => (
                  <Card
                    key={index}
                    className={`${plan.popular ? "bg-[#efa72d] text-[#17457c] border-[#edf3f1] scale-105" : "bg-[#6b839a] text-[#edf3f1] border-[#efa72d]"} border-4 shadow-[8px_8px_0px_0px_${plan.popular ? "#edf3f1" : "#efa72d"}] relative ${!plan.available ? "opacity-60" : ""}`}
                  >
                    {plan.popular && (
            ...
            <div className="container px-4 md:px-6 mx-auto max-w-7xl text-center">
              <div className="max-w-4xl mx-auto space-y-8">
                ...
                <p className="text-xl font-bold">
                  Join 2,800+ researchers, analysts, and strategists who trust DeepDive for critical insights.
                </p>
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  ...
                  <Link href="https://docs.VENYM_SEARCH.com/deepdive">
                    <Button
                      variant="outline"
                      size="lg"
            ...
            <div className="grid gap-8 lg:grid-cols-4">
              ...
              <div className="space-y-4">
                ...
                <nav className="flex flex-col gap-2">
                  <Link href="/products/swiftsearch" className="font-black text-gray-400 hover:text-[#efa72d] transition-colors">
                    SwiftSearch
                  </Link>
                  <Link href="/products/scrapeforge" className="font-black text-gray-400 hover:text-[#efa72d] transition-colors">
                    ScrapeForge
                  </Link>
                  <Link href="/products/deepdive" className="font-black text-[#efa72d] hover:text-white transition-colors">
                    DeepDive
                  </Link>
                </nav>
              </div>
