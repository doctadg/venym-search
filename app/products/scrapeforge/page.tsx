...
export default function ScrapeForgePage() {
                ...
                <div className="flex-1 space-y-8">
                  <div className="space-y-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-none">
                      <span className="block text-[#efa72d]">SCRAPEFORGE</span>
                  ...
                  <Card className="bg-black border-4 border-[#efa72d] shadow-[12px_12px_0px_0px_#efa72d]">
                    <CardContent className="p-8">
                      <pre className="text-green-400 font-mono text-sm overflow-x-auto">
                        {`curl -X POST "https://www.search.venym.io/api/v1/scrapeforge" \
                ...
                {[
                  {
                    ...
                    solution: "ScrapeForge bypasses protection with 99.3% success rate"
                  },
                  {
                    icon: Clock,
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="border-t border-gray-700 pt-4">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="font-black text-[#efa72d]">ScrapeForge Solution:</span>
                        </div>
            ...
            <div className="container px-4 md:px-6 mx-auto max-w-7xl">
              <div className="text-center mb-16">
                ...
                <p className="text-xl font-bold max-w-3xl mx-auto">
                  Enterprise teams using ScrapeForge for mission-critical data extraction
                </p>
              </div>
            ...
            <div className="container px-4 md:px-6 mx-auto max-w-7xl text-center">
              <div className="max-w-4xl mx-auto space-y-8">
                ...
                <p className="text-xl font-bold">
                  Join 1,890+ developers who replaced their scraping infrastructure with ScrapeForge.
                </p>
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  ...
                  <Link href="https://docs.VENYM_SEARCH.com/scrapeforge">
                    <Button
                      variant="outline"
                      size="lg"
            ...
            <div className="grid gap-8 lg:grid-cols-4">
              ...
              <div className="space-y-4">
                ...
                <nav className="flex flex-col gap-2">
                  ...
                  <Link href="/products/scrapeforge" className="font-black text-[#efa72d] hover:text-white transition-colors">
                    ScrapeForge
                  </Link>
                  <Link href="/products/deepdive" className="font-black text-gray-400 hover:text-[#efa72d] transition-colors">
                    DeepDive
                  </Link>
                </nav>
              </div>
