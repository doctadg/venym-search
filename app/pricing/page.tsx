...
type Plan = {
  id: 'free' | 'starter' | 'builder' | 'unicorn'
  name: string
  tagline: string
  monthly: number | null
  annual: number | null
...
const PLANS: Plan[] = [
  {
    ...
    cta: 'Start Free',
    features: [
      { label: 'Credits per month', value: '500' },
      { label: 'All APIs' },
      { label: 'Basic support' },
  ...
  },
  {
    id: 'unicorn',
    name: 'Unicorn',
    tagline: 'High volume, maximum speed.',
    monthly: 199,
    annual: 159,
    credits: '500,000',
    creditsNum: 500_000,
...
const COMPARE_ROWS: { label: string; values: (string | boolean)[]; group?: string }[] = [
  { group: 'Credits & APIs', label: 'Monthly credits', values: ['500', '5,000', '100,000', '500,000'] },
  { label: 'Search API', values: [true, true, true, true] },
  { label: 'Scrape API', values: [true, true, true, true] },
  { group: 'Platform', label: 'Dashboard access', values: [true, true, true, true] },
  { label: 'Webhooks', values: [false, false, true, true] },
  { label: 'Advanced analytics', values: [false, false, true, true] },
  { group: 'Support', label: 'Support', values: ['Basic', 'Basic', 'Priority', 'Dedicated engineer'] },
  { label: 'SLA guarantees', values: [false, false, false, true] },
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Every account starts with 500 free credits — enough to evaluate all APIs. No card required to start.',
  },
  {
...
function CreditCalculator() {
  ...
  const recommended = useMemo(() => {
    if (totalCredits <= 500) return PLANS[0]
    if (totalCredits <= 5_000) return PLANS[1]
    if (totalCredits <= 100_000) return PLANS[2]
    return PLANS[3]
  }, [totalCredits])
    ...
    <div className="grid lg:grid-cols-[1.1fr_1fr] gap-6">
      ...
      <div className="venym-glow-card p-7 md:p-9 flex flex-col justify-between min-h-full">
        ...
        <div className="mt-8 pt-6 border-t border-white/[0.06]">
          ...
          <Link
            href={`/signup?plan=${recommended.id}`}
      ...
      <section className="relative overflow-hidden border-b border-white/[0.06]">
        ...
        <div className="relative max-w-[1280px] mx-auto px-5 pt-20 pb-14 md:pt-28 md:pb-20 text-center">
          ...
          <p className="mt-7 text-[15px] md:text-base text-white/45 leading-relaxed max-w-xl mx-auto">
            One credit equals $0.0001. All APIs share one balance. Start free, scale to half a million calls,
      ...
      <section className="relative px-5 py-24 md:py-32 border-t border-white/[0.06] overflow-hidden">
        ...
        <div className="relative max-w-[1000px] mx-auto text-center">
          ...
          <p className="text-white/40 text-[15px] max-w-lg mx-auto leading-relaxed mb-9">
            Three production APIs behind one key. 500 credits to evaluate. No card, no demo, no sales call.
          </p>
