...
export default function ScrapeForgeAPIReferencePage() {
  const parameters = [
    {
      name: "url",
      type: "string",
    ...
    <div className="max-w-none">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[#17457c]">ScrapeForge API Reference</h1>
        ...
        <Callout type="success" title="Enterprise Web Scraping">
          Test ScrapeForge's enterprise-grade scraping capabilities including JavaScript rendering, 
      ...
      <div className="mb-12">
        <APITester
          ...
          demoApiKey="demo_sk_scrapeforge_67890"
        />
      </div>
...
{`{
  ...
  "proxy_country": "US"
      ...
      <div className="flex justify-between pt-8 border-t">
        <Link href="/docs/api-reference/swiftsearch">
          <Button variant="outline" className="flex items-center gap-2">
            <ArrowRight className="w-4 h-4 rotate-180" />
            SwiftSearch API Reference
          </Button>
        </Link>
        <Link href="/docs/api-reference/deepdive">
