...
export default function SwiftSearchAPIReferencePage() {
  const parameters = [
    {
      name: "query",
      type: "string",
    ...
    <div className="max-w-none">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[#17457c]">SwiftSearch API Reference</h1>
        ...
        <Callout type="info" title="Interactive API Testing">
          Test the SwiftSearch API directly from this page with live examples. 
      ...
      <div className="mb-12">
        <APITester
          endpoint="https://www.search.venym.io/api/v1/swiftsearch"
          method="POST"
          ...
          demoApiKey="demo_sk_swiftsearch_12345"
        />
      </div>
