...
export default function SwiftSearchExamplesPage() {
  const basicSearch = {
    ...
    <div className="max-w-none">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[#17457c]">SwiftSearch Examples</h1>
            <p className="text-gray-600">Real-world use cases and implementation patterns</p>
          </div>
        </div>

        <div className="flex gap-3 mb-6">
          <Link href="/docs/api/swiftsearch/parameters">
