...
export default function SwiftSearchParametersPage() {
    ...
    <div className="max-w-none">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[#17457c]">SwiftSearch Parameters</h1>
            <p className="text-gray-600">Complete parameter reference for the SwiftSearch API</p>
          </div>
        </div>
        ...
        <div className="flex gap-3 mb-6">
          ...
          <Link href="/docs/api/swiftsearch/examples">
            <Button variant="outline" size="sm">
              Examples →
            </Button>
          </Link>
      ...
      <div className="mb-12">
        ...
        <div className="mb-6">
          <ParameterTable 
            ...
            title="SwiftSearch Request Parameters"
          />
        </div>
      ...
      <div className="mb-12">
        ...
        <ResponseTable 
          ...
          title="SwiftSearch Response Fields"
        />
      </div>
        ...
        <div className="space-y-8">
          <div>
            ...
            <CodeBlock 
              ...
              title="Minimal SwiftSearch Request"
            />
          </div>
          ...
          <div>
            ...
            <CodeBlock 
              ...
              title="Advanced SwiftSearch Request"
            />
          </div>
        </div>
      </div>
