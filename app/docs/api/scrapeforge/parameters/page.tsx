...
export default function ScrapeForgeParametersPage() {
    ...
    <div className="max-w-none">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[#17457c]">ScrapeForge Parameters</h1>
        ...
        <Callout type="info" title="Enterprise Features">
          ScrapeForge includes advanced features like JavaScript rendering, residential proxies, 
        ...
        <div className="space-y-8">
          <div>
            ...
            <CodeBlock 
              ...
              title="Basic ScrapeForge Request"
            />
          </div>
          ...
          <div>
            ...
            <CodeBlock 
              ...
              title="Advanced ScrapeForge Request"
            />
          </div>
        </div>
      </div>
